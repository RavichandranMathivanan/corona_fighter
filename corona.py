...
# Player
playerImg = pygame.image.load("corona_fighter.png")
playerX = 370
playerY = 520
playerX_change = 0
...
def show_score(x, y):
    score = font.render("People Recovered :" + str(score_value), True, (255, 255, 255))
    screen.blit(score, (x, y))


def game_over():
    over_text = over_font.render("YOU NEED TO QUARANTINE!", True, (255, 0, 0))
